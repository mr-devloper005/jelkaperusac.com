export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'jelkaperusac',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Jelkaperusac',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'jelkaperusac.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://jelkaperusac.com',
